              ...
              if (null !== renderedTail) {
                ...
                for (newProps = workInProgress.child; null !== newProps; )
                  (rootContainerInstance = newProps),
                    ...
                    (renderedTail = rootContainerInstance.alternate),
                    null === renderedTail
                      ...
                      : ((rootContainerInstance.childLanes =
                          renderedTail.childLanes),
                        (rootContainerInstance.lanes = renderedTail.lanes),
                        (rootContainerInstance.child = renderedTail.child),
                        ...
                        (rootContainerInstance.updateQueue =
                          renderedTail.updateQueue),
                        (rootContainerInstance.type = renderedTail.type),
                        (renderLanes = renderedTail.dependencies),
      ...
      if (null !== current) {
        ...
        do {
          if (3 === (finishedRoot.tag & 3)) {
            var create$77 = finishedRoot.create;
            finishedRoot.destroy = create$77();
          }
      ...
      a: {
        ...
        if (
          ...
          var hasInvisibleParentBoundary =
              0 !== (suspenseStackCursor.current & 1),
            workInProgress$72 = returnFiber;
          do {
            var JSCompiler_temp;
            if ((JSCompiler_temp = 13 === workInProgress$72.tag)) {
              var nextState = workInProgress$72.memoizedState;
              if (null !== nextState)
                JSCompiler_temp = null !== nextState.dehydrated ? !0 : !1;
              else {
                var props = workInProgress$72.memoizedProps;
                JSCompiler_temp =
            ...
            if (JSCompiler_temp) {
              var wakeables = workInProgress$72.updateQueue;
              if (null === wakeables) {
                var updateQueue = new Set();
                updateQueue.add(wakeable);
                workInProgress$72.updateQueue = updateQueue;
              } else wakeables.add(wakeable);
              if (0 === (workInProgress$72.mode & 2)) {
                workInProgress$72.flags |= 64;
              ...
              workInProgress$72.flags |= 4096;
              workInProgress$72.lanes = thrownValue;
              break a;
            }
            workInProgress$72 = workInProgress$72.return;
          } while (null !== workInProgress$72);
          value = Error(
        ...
        workInProgress$72 = returnFiber;
        do {
          switch (workInProgress$72.tag) {
            case 3:
              root = value;
              workInProgress$72.flags |= 4096;
              thrownValue &= -thrownValue;
              workInProgress$72.lanes |= thrownValue;
              var update$73 = createRootErrorUpdate(
                workInProgress$72,
                root,
                thrownValue
              );
              enqueueCapturedUpdate(workInProgress$72, update$73);
              break a;
            case 1:
              root = value;
              var ctor = workInProgress$72.type,
                instance = workInProgress$72.stateNode;
              if (
                0 === (workInProgress$72.flags & 64) &&
                ...
                thrownValue &= -thrownValue;
                workInProgress$72.lanes |= thrownValue;
                var update$76 = createClassErrorUpdate(
                  workInProgress$72,
                  root,
                  thrownValue
                );
                enqueueCapturedUpdate(workInProgress$72, update$76);
                break a;
              }
          }
          workInProgress$72 = workInProgress$72.return;
...
function flushPassiveEffectsImpl() {
  ...
  for (create$94 = root.current.firstEffect; null !== create$94; )
    (root = create$94.nextEffect),
      (create$94.nextEffect = null),
      create$94.flags & 8 &&
        ((create$94.sibling = null), (create$94.stateNode = null)),
      (create$94 = root);
  executionContext = prevExecutionContext;
  flushSyncCallbackQueue();
  return !0;
...
var devToolsConfig$jscomp$inline_733 = {
...
var internals$jscomp$inline_877 = {
  bundleType: devToolsConfig$jscomp$inline_733.bundleType,
  version: devToolsConfig$jscomp$inline_733.version,
  rendererPackageName: devToolsConfig$jscomp$inline_733.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_733.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_733.findFiberByHostInstance ||
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_878 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_878.isDisabled &&
    hook$jscomp$inline_878.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_878.inject(internals$jscomp$inline_877)),
        (injectedHook = hook$jscomp$inline_878);
    } catch (err) {}
}
