...
if(!b.isDisabled&&b.supportsFiber)try{Wc=b.inject(a),Ba=b}catch(c){}a=!0}return a})({findFiberByHostInstance:function(){throw Error("TestRenderer does not support findFiberByHostInstance()");},bundleType:0,version:"17.0.0",rendererPackageName:"react-test-renderer"});P._Scheduler=Xa;P.act=function(a){function b(){kc--;ud.current=c}!1===We&&(We=!0,console.error("act(...) is not supported in production builds of React, and might not behave as expected."));kc++;var c=ud.current;ud.current=!0;try{var d=
fd(a)}catch(e){throw b(),e;}if(null!==d&&"object"===typeof d&&"function"===typeof d.then)return{then:function(a,f){d.then(function(){1<kc||!0===Ve&&!0===c?(b(),a()):Oe(function(c){b();c?f(c):a()})},function(a){b();f(a)})}};try{1!==kc||!1!==Ve&&!1!==c||jd(),b()}catch(e){throw b(),e;}return{then:function(a){a()}}};P.create=function(a,b){var c=eg,d=!1;"object"===typeof b&&null!==b&&("function"===typeof b.createNodeMock&&(c=b.createNodeMock),!0===b.unstable_isConcurrent&&(d=!0));var e={children:[],createNodeMock:c,
tag:"CONTAINER"},f=Yf(e,d?2:0,!1);if(null==f)throw Error(m(215));nd(a,f,null,null);a={_Scheduler:Xa,root:void 0,toJSON:function(){if(null==f||null==f.current||null==e||0===e.children.length)return null;if(1===e.children.length)return hc(e.children[0]);if(2===e.children.length&&!0===e.children[0].isHidden&&!1===e.children[1].isHidden)return hc(e.children[1]);var a=null;if(e.children&&e.children.length)for(var b=0;b<e.children.length;b++){var c=hc(e.children[b]);null!==c&&(null===a?a=[c]:a.push(c))}return a},
toTree:function(){return null==f||null==f.current?null:ic(f.current)},update:function(a){null!=f&&null!=f.current&&nd(a,f,null,null)},unmount:function(){null!=f&&null!=f.current&&(nd(null,f,null,null),f=e=null)},getInstance:function(){if(null==f||null==f.current)return null;a:{var a=f.current;if(a.child)switch(a.child.tag){case 5:a=Bb(a.child.stateNode);break a;default:a=a.child.stateNode}else a=null}return a},unstable_flushSync:function(a){a:{var b=q;if(0!==(b&48))var c=a(void 0);else{q|=1;try{c=
a?La(99,a.bind(null,void 0)):void 0;break a}finally{q=b,Ma()}c=void 0}}return c}};Object.defineProperty(a,"root",{configurable:!0,enumerable:!0,get:function(){if(null===f)throw Error("Can't access .root on unmounted test renderer");var a=od(f.current);if(0===a.length)throw Error("Can't access .root on unmounted test renderer");return 1===a.length?a[0]:qd(f.current)}});return a};P.unstable_batchedUpdates=fd;P.unstable_concurrentAct=function(a){if(void 0===Xa.unstable_flushAllWithoutAsserting)throw Error("This version of `act` requires a special mock build of Scheduler.");
