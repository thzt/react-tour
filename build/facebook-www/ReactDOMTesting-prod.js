...
if (canUseDOM) {
  var JSCompiler_inline_result$jscomp$155;
  if (canUseDOM) {
    var isSupported$jscomp$inline_270 = "oninput" in document;
    if (!isSupported$jscomp$inline_270) {
      var element$jscomp$inline_271 = document.createElement("div");
      element$jscomp$inline_271.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_270 =
        "function" === typeof element$jscomp$inline_271.oninput;
    }
    JSCompiler_inline_result$jscomp$155 = isSupported$jscomp$inline_270;
  } else JSCompiler_inline_result$jscomp$155 = !1;
  isInputEventSupported =
    JSCompiler_inline_result$jscomp$155 &&
...
var COMPONENT_TYPE = 0,
  ...
  TEXT_TYPE = 4;
if ("function" === typeof Symbol && Symbol.for) {
  var symbolFor$119 = Symbol.for;
  COMPONENT_TYPE = symbolFor$119("selector.component");
  HAS_PSEUDO_CLASS_TYPE = symbolFor$119("selector.has_pseudo_class");
  ROLE_TYPE = symbolFor$119("selector.role");
  TEST_NAME_TYPE = symbolFor$119("selector.test_id");
  TEXT_TYPE = symbolFor$119("selector.text");
}
      ...
      a: {
        ...
        if (
          ...
          var hasInvisibleParentBoundary =
              0 !== (suspenseStackCursor.current & 1),
            workInProgress$108 = returnFiber;
          do {
            var JSCompiler_temp;
            if ((JSCompiler_temp = 13 === workInProgress$108.tag)) {
              var nextState = workInProgress$108.memoizedState;
              if (null !== nextState)
                JSCompiler_temp = null !== nextState.dehydrated ? !0 : !1;
              else {
                var props = workInProgress$108.memoizedProps;
                JSCompiler_temp =
            ...
            if (JSCompiler_temp) {
              var wakeables = workInProgress$108.updateQueue;
              if (null === wakeables) {
                var updateQueue = new Set();
                updateQueue.add(wakeable);
                workInProgress$108.updateQueue = updateQueue;
              } else wakeables.add(wakeable);
              if (0 === (workInProgress$108.mode & 2)) {
                workInProgress$108.flags |= 64;
              ...
              workInProgress$108.flags |= 4096;
              workInProgress$108.lanes = thrownValue;
              break a;
            }
            workInProgress$108 = workInProgress$108.return;
          } while (null !== workInProgress$108);
          value = Error(
        ...
        workInProgress$108 = returnFiber;
        do {
          switch (workInProgress$108.tag) {
            case 3:
              root = value;
              workInProgress$108.flags |= 4096;
              thrownValue &= -thrownValue;
              workInProgress$108.lanes |= thrownValue;
              var update$109 = createRootErrorUpdate(
                workInProgress$108,
                root,
                thrownValue
              );
              enqueueCapturedUpdate(workInProgress$108, update$109);
              break a;
            case 1:
              root = value;
              var ctor = workInProgress$108.type,
                instance = workInProgress$108.stateNode;
              if (
                0 === (workInProgress$108.flags & 64) &&
                ...
                thrownValue &= -thrownValue;
                workInProgress$108.lanes |= thrownValue;
                var update$112 = createClassErrorUpdate(
                  workInProgress$108,
                  root,
                  thrownValue
                );
                enqueueCapturedUpdate(workInProgress$108, update$112);
                break a;
              }
          }
          workInProgress$108 = workInProgress$108.return;
...
function commitRootImpl(root, renderPriorityLevel) {
  ...
  if (null !== remainingLanes) {
    ...
    eventTimes = null;
    expirationTimes = selectionInformation.focusedElem;
    null !== expirationTimes &&
      (eventTimes = getClosestInstanceFromNode(expirationTimes));
    _enabled = !1;
    focusedInstanceHandle = eventTimes;
    shouldFireAfterActiveInstanceBlur = !1;
...
function flushPassiveEffectsImpl() {
  ...
  for (var i = 0; i < unmountEffects.length; i += 2) {
    var effect$130 = unmountEffects[i],
      fiber = unmountEffects[i + 1],
      destroy = effect$130.destroy;
    effect$130.destroy = void 0;
  ...
  for (i = 0; i < unmountEffects.length; i += 2) {
    effect$130 = unmountEffects[i];
    fiber = unmountEffects[i + 1];
    try {
      var create = effect$130.create;
      effect$130.destroy = create();
    } catch (error$134) {
      if (null === fiber) throw Error(formatProdErrorMessage(330));
      captureCommitPhaseError(fiber, error$134);
    }
  }
  ...
  if (mutableSources)
    for (container = 0; container < mutableSources.length; container++)
      (tag = mutableSources[container]),
        (hydrationCallbacks = tag._getVersion),
        (hydrationCallbacks = hydrationCallbacks(tag._source)),
...
attemptSynchronousHydration = function(fiber) {
  switch (fiber.tag) {
    case 3:
      var root$136 = fiber.stateNode;
      if (root$136.hydrate) {
        var lanes = getHighestPriorityLanes(root$136.pendingLanes);
        root$136.expiredLanes |= lanes & root$136.pendingLanes;
        ensureRootIsScheduled(root$136, now());
...
var internals$jscomp$inline_1571 = {
  ...
  function eventHandle(target, callback) {
    ...
    if (
      ...
      if ("function" === typeof target.addEventListener)
        listenToNativeEvent(type, isCapturePhaseListener, target, null, 1);
